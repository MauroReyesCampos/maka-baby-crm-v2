                                ...
                                <div className="flex flex-wrap gap-2">
                                    ...
                                    {canEditOrDelete && (
                                        <div className="flex gap-2 w-full">
                                            <button onClick={() => handleOpenModal(sale)} className="flex-1 flex items-center justify-center gap-2 px-4 py-3 bg-white border border-[#e8eeee] rounded-xl text-sm font-bold shadow-sm active:scale-95 transition-all text-accent">
                                                <Edit2 className="w-4 h-4" />
                                                Editar
                                            </button>
